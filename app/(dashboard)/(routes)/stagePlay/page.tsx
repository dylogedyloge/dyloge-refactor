      ...
      <div className="mx-6 relative flex flex-col justify-center items-center min-h-screen overflow-hidden">
        <div className="w-full ">
          <Card className="pt-6">
            <CardHeader>
              <CardTitle>
                <Heading title="Stage Play" icon={GiDualityMask} />
              </CardTitle>
            </CardHeader>
            <CardContent className="grid gap-4">
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                  <AccordionTrigger>Type of Stage Play</AccordionTrigger>
                  <AccordionContent>
                    <RadioGroup
                      defaultValue="short-stageplay"
              ...
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                  <AccordionTrigger>Genre of Stage Play</AccordionTrigger>
                  <AccordionContent>
